...
public class CHTraceLineChart extends LineChart {
    public CHTraceLineChart(Context context) {
        super(context);
        initMyChart();
    }

    public CHTraceLineChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        initMyChart();
    }

    public CHTraceLineChart(Context context, AttributeSet attrs, int defStyle) {
