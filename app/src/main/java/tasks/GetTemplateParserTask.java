...
public class GetTemplateParserTask extends BaseAsyncTask<byte[],Integer,Integer> {
    ...
    public GetTemplateParserTask(Response.Listener<Integer> listener, Context context,byte[] responseData) {
...
//        this.TNDP = point_count;
        ...
        ParserGetTemplateData parserGetTemplateData = ParserGetTemplateData.initAllAttri(d,point_count);
